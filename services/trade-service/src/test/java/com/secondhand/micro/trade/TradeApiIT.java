...
class TradeApiIT {
 ...
 @Test void anonymousMalformedOrderIsRejectedBeforeSideEffects(){assertEquals(401,Http.call(url,"POST","/api/orders",Map.of("productId",1,"receiverName","","receiverPhone","","receiverAddress",""),null,"invalid").status());}
