...
生成时间：2026-09-01T21:07:33.450923+08:00
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.44 秒。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.192 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/user-service/src/test/java/com/secondhand/micro/user/UserApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：1.066 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/user-service/src/test/java/com/secondhand/micro/user/UserApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.111 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/user-service/src/test/java/com/secondhand/micro/user/UserApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.386 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.094 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/product-service/src/test/java/com/secondhand/micro/product/InventoryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.12 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/product-service/src/test/java/com/secondhand/micro/product/InventoryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.39 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/product-service/src/test/java/com/secondhand/micro/product/InventoryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.019 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/product-service/src/test/java/com/secondhand/micro/product/InventoryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.166 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/product-service/src/test/java/com/secondhand/micro/product/InventoryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.073 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/product-service/src/test/java/com/secondhand/micro/product/InventoryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.22 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.013 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/trade-service/src/test/java/com/secondhand/micro/trade/TradeApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.017 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../services/trade-service/src/test/java/com/secondhand/micro/trade/TradeApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：27.483 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.795 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.743 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.84 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.691 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.596 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.715 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.618 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.553 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.599 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.53 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.518 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.51 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.629 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/aftersale/AfterSaleApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.125 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.163 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/auth/AuthFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.381 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/auth/AuthFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.201 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/auth/AuthFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.236 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/auth/AuthFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.041 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/auth/AuthFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.037 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/auth/AuthFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.57 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.185 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/micro/system/BusinessFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.438 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/micro/system/BusinessFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.028 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/micro/system/BusinessFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：1.72 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/micro/system/BusinessFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.4 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/micro/system/BusinessFlowIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：2.003 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
6. 查询支付状态：`GET /api/payments/PAY-48b877be-0628-4776-ac7e-2146c294b0a6` → HTTP 200。
7. 开发测试模拟支付成功：`POST /api/payments/PAY-48b877be-0628-4776-ac7e-2146c294b0a6/mock-pay?orderId=25` → HTTP 404。
8. 开发测试模拟支付成功：`POST /api/payments/PAY-48b877be-0628-4776-ac7e-2146c294b0a6/mock-pay?orderId=25` → HTTP 200。
9. 查询支付状态：`GET /api/payments/PAY-48b877be-0628-4776-ac7e-2146c294b0a6` → HTTP 200。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.526 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/migration/ComplementaryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.665 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/migration/ComplementaryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：2.507 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/migration/ComplementaryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.936 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/migration/ComplementaryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.937 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/migration/ComplementaryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.61 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/migration/ComplementaryApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.317 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.293 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/offer/OfferApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.452 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/offer/OfferApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.229 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/offer/OfferApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.495 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/offer/OfferApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.327 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/offer/OfferApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.332 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/offer/OfferApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.365 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/offer/OfferApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.585 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.47 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/PurchaseApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.46 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/PurchaseApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.412 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/PurchaseApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.251 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/PurchaseApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.443 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/PurchaseApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.435 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/ShippingApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.369 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/ShippingApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.403 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/ShippingApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.451 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/order/ShippingApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.183 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.145 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/product/ProductApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.097 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/product/ProductApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.206 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/product/ProductApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.232 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/report/ReportApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.122 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/report/ReportApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.307 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/report/ReportApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：2.334 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/report/ReportApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：4.278 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
- 代码与数据准备：[测试源码](../tests/system-tests/src/test/java/com/secondhand/report/ReportApiIT.java)。
...
- 流程类型：集成/API或可靠性边界；结果：**通过**；耗时：0.012 秒。
- 前置条件：服务及所属数据库就绪，使用本例创建的参与者和业务记录；管理员场景使用测试夹具显式建立的管理员。
